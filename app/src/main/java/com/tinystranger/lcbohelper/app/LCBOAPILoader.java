 ...
 */
class LCBOAPILoader extends AsyncTaskLoader<List<LCBOEntity>> {
    private String url;
    private LCBOAPIParser.QueryType queryType;
    public LCBOAPILoader(Context context, Bundle args, LCBOAPIParser.QueryType QueryType) {
        super(context);
    ...
    public List<LCBOEntity> loadInBackground() {
        ...
        try {
            result = loadLCBOAPIFromNetwork(url);
    ...
    private List<LCBOEntity> loadLCBOAPIFromNetwork(String urlString) throws XmlPullParserException, IOException {
        InputStream stream = null;
        LCBOAPIParser parser = new LCBOAPIParser();
